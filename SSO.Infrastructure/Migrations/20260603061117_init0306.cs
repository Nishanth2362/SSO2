...
{
    /// <inheritdoc />
    public partial class init0306 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TriggerEvent = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RequireLicense = table.Column<bool>(type: "bit", nullable: false),
                    LogoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Website = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AppClientType = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxApps = table.Column<int>(type: "int", nullable: false),
                    AllowSeparateDb = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatabaseMode = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationClientScopes", x => new { x.ClientId, x.ScopeId });
                    table.ForeignKey(
                        name: "FK_ApplicationClientScopes_OpenIddictApplications_ClientId",
                        column: x => x.ClientId,
                        principalTable: "OpenIddictApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationClientScopes_OpenIddictScopes_ScopeId",
                        column: x => x.ScopeId,
                        principalTable: "OpenIddictScopes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "ApplicationScopePermissions",
                columns: table => new
                {
                    ScopeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationScopePermissions", x => new { x.ScopeId, x.PermissionId });
                    table.ForeignKey(
                        name: "FK_ApplicationScopePermissions_OpenIddictScopes_ScopeId",
                        column: x => x.ScopeId,
                        principalTable: "OpenIddictScopes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationScopePermissions_Permissions_PermissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OpenIddictAuthorizations_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TenantClients_OpenIddictApplications_ApplicationClientId",
                        column: x => x.ApplicationClientId,
                        principalTable: "OpenIddictApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TenantClients_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.RoleId, x.PermissionId, x.ApplicationClientId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePermissions_OpenIddictApplications_ApplicationClientId",
                        column: x => x.ApplicationClientId,
                        principalTable: "OpenIddictApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OpenIddictTokens_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationClientScopes_ScopeId",
                table: "ApplicationClientScopes",
                column: "ScopeId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationScopePermissions_PermissionId",
                table: "ApplicationScopePermissions",
                column: "PermissionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpenIddictAuthorizations_TenantId",
                table: "OpenIddictAuthorizations",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpenIddictTokens_TenantId",
                table: "OpenIddictTokens",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_ApplicationClientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantClients_ApplicationClientId",
                table: "TenantClients",
                column: "ApplicationClientId");
