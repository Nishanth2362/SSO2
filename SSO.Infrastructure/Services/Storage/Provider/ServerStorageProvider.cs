...
namespace SSO.Infrastructure.Services.Storage.Provider
{
    public class ServerStorageProvider : IStorageProvider
    {
        ...
        private readonly ILogger<ServerStorageProvider> _logger;
        public ServerStorageProvider(ICurrentUserService currentUserService, ILogger<ServerStorageProvider> logger)
        {
