...
namespace SSO.Common.Wrapper
{
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public static Result<T> ValidationFail(IEnumerable<ValidationError> errors) => new()
        {
            Succeeded = false,
            ValidationErrors = errors.ToList()
        };

        public static new Task<Result<T>> ValidationFailAsync(IEnumerable<ValidationError> errors) => Task.FromResult(ValidationFail(errors));
